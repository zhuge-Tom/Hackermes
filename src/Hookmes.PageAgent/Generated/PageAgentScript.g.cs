// <auto-generated />
// 由 src/Hookmes.PageAgent/build.mjs 生成,请勿手工编辑。
// 修改 TypeScript 源码后运行:npm install && npm run build

namespace Hookmes.PageAgent;

/// <summary>
/// Page Agent 脚本常量。
/// <para>
/// 注入前需把 <c>__HOOKMES_BINDING__</c> 占位符替换成本次会话的实际绑定名,
...
public static class PageAgentScript
{
    ...
    public const string BindingPlaceholder = "__HOOKMES_BINDING__";
